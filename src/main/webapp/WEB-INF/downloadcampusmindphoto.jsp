...
<title>Download CampusMind photo</title>
<!-- Font Awesome -->
<link rel="stylesheet"
...
<body class="register-page">
														...
														<form id="form">
															<div class="md-form">
																<i class="far fa-user prefix"></i> <input name="MID"
																	placeholder="Enter MID" type="text" id="MID" maxlength="8"
																	class="form-control transparent-input" />
															</div>
															<div class="text-center">
																<button type="submit" id="submitbtn"
																	class="btn btn-indigo btn-rounded mt-5">Download</button>
															</div>
	...
	function check() {
		...
		if (!(/^[0-9]{1,9}$/.test(+y))) {
		 ...
		 window.open("http://localhost:8080/admin/photo/download/"+x);
